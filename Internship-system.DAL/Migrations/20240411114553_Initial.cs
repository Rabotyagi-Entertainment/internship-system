        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPartner = table.Column<bool>(type: "boolean", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternshipProgresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InternshipProgresses_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InternshipProgresses_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CuratorFullName = table.Column<string>(type: "text", nullable: true),
                    TaskReportTable = table.Column<string>(type: "text", nullable: true),
                    CourseWorkName = table.Column<string>(type: "text", nullable: true),
                    PlanTable = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PracticeDiaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PracticeDiaries_Internships_InternshipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_PracticeDiaryId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InternshipProgresses_CompanyId",
                table: "InternshipProgresses",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_InternshipProgresses_StudentId",
                table: "InternshipProgresses",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PracticeDiaries_InternshipId",
